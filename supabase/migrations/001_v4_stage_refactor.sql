...
-- ============================================================================
-- STEP 2: Add comments to deprecated columns (keep for backward compatibility)
-- ============================================================================

COMMENT ON COLUMN projects.tax_rate IS 'DEPRECATED in v4.0 - kept for backward compatibility';
COMMENT ON COLUMN projects.tax_amount IS 'DEPRECATED in v4.0 - kept for backward compatibility';
COMMENT ON COLUMN projects.tax_primary_rate IS 'DEPRECATED in v4.0 - kept for backward compatibility';
COMMENT ON COLUMN projects.tax_secondary_rate IS 'DEPRECATED in v4.0 - kept for backward compatibility';
COMMENT ON COLUMN projects.final_payment_amount IS 'DEPRECATED in v4.0 - kept for backward compatibility';
COMMENT ON COLUMN projects.final_payment_date IS 'DEPRECATED in v4.0 - kept for backward compatibility';

-- ============================================================================
-- STEP 3: Add new enum values (keeping old ones temporarily for migration)
-- ============================================================================
...
-- ============================================================================
-- STEP 4: Migrate existing data to new stage values
-- ============================================================================
...
-- ============================================================================
-- STEP 5: Populate new fields from existing data for completed projects
-- ============================================================================
...
-- ============================================================================
-- STEP 6: Remove old enum values (must be done after all data is migrated)
-- ============================================================================
...
-- ============================================================================
-- STEP 7: Add indexes for performance on new columns
-- ============================================================================
